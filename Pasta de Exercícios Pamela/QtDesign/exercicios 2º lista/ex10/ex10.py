...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(130, 20, 521, 61))
        font = QtGui.QFont()
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(250, 100, 298, 80))
        ...
        self.label_2.setGeometry(QtCore.QRect(300, 210, 211, 201))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Digita 5 números ai que eu vou fazer uma graça chefe"))
        self.pushButton.setText(_translate("MainWindow", "Beleza"))
